  ...
  USERS: [
    {
      ...
      useTemplateId: 'mjXcWB6Pj2Tt5FjW_ti1PMOzUcvVotW_nPv2xwu2DLw',
      // 所在省份或城市，也可以不填
      province: '',
      // 所在城市或县区
      city: '太原',
      ...
      festivals: [
        {
          type: '生日', name: '笑笑', year: '1996', date: '11-28',
        },
        {
          type: '节日', name: '在一起', year: '2015', date: '11-12',
        },
        {
          type: '生日', name: '超超', year: '1997', date: '09-07',
        }
      ],
  ...
  CALLBACK_USERS: [
    {
      ...
      // 使用其他通道时，请严格按照各个通道的教程进行填写
      id: 'ofXps5typJQYHezw50OsUbYH7vkI',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
